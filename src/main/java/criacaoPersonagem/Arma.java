...
public class Arma {
	...
	public String toString() {
		return "Arma [idArma=" + idArma + ", nomeArma=" + nomeArma + ", precoArma=" + precoArma + ", pesoArma="
				...
				+ ", AtaqueArma=" + AtaqueArma + ", AtaqueMagia=" + AtaqueMagia + "]";
	}
	...
	public Integer getAtaqueMagia() {
		return AtaqueMagia;
	}
	public void setAtaqueMagia(Integer ataqueMagia) {
		AtaqueMagia = ataqueMagia;
	}
