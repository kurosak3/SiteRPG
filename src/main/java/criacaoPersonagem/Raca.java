...
public class Raca {
	...
	public Raca(Integer idRaca, String nomeRaca, Integer bonusForca, Integer bonusDestreza, Integer bonusonstituicao,
			Integer bonusInteligencia, Integer bonusSabedoria, Integer bonusCarisma, String habilidadeRaca,
	...
	public String getHabilidadeRaca() {
		return habilidadeRaca;
	}

	public void setHabilidadeRaca(String habilidadeRaca) {
		this.habilidadeRaca = habilidadeRaca;
	}
